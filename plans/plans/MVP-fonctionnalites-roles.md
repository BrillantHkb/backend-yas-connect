...
| Organigramme (directions, départements, services) | Un administrateur structure vraiment l’entreprise en unités, pour que la fiche collègue et le picker s’appuient sur une organisation réelle, pas juste une case texte. |
| Muter quelqu’un / historique d’affectation | Suivre les mouvements RH (changement de service, de poste) et garder une trace, sans perdre l’ancien historique ; la fiche du collègue se met à jour automatiquement. |
| Déclarer ses compétences | Se signaler comme ressource sur un sujet (fibre optique, sécurité réseau…) pour que l’équipe le sache — soi-même ou un responsable pour un collègue. |
| Déclarer ses certifications / diplômes | Garder une preuve d’une formation ou d’un diplôme, avec éventuellement le document justificatif déjà uploadé. |
